/**
 * \file
 * \brief Declarations and definitions of SBF (Septentrio Binary Format) blocks.
 *
...
#define SBF_PVTERR_STDLIMITEXCEEDED          31 /*!< Error flag if standard deviation of
                                                     ...
                                                     user limit */
#define SBF_PVTERR_UNSUPPORTEDSETTINGSINS    32 /*!< user provided settings are not supported
                                                     in INS */
...
#define INSNAV_SBLIST_POSITION_COV               0x0020    /* Bit 5 */
#define INSNAV_SBLIST_ATTITDE_COV                0x0040    /* Bit 6 */
#define INSNAV_SBLIST_VELOCITY_COV               0x0080    /* Bit 7 */
...
#define SBF_SAPA      0x04
#define SBF_RTCM3_ENC 0x05

#define SBF_DIFFCORRIN_1_0_FRAME_LENGTH  DIFFCORR_FRAME_MAX_NBR_WORDS * 4

/*--RawDataIn_1_0_t : -------------------------------------------------------*/

#define SBF_RAWDATAIN_UNKNOWN 0x00
#define SBF_RAWDATAIN_LBMP    0x01
...
#define EXTSENSORSBF_SENSORMODEL_HGUIDE         8
...
#define SBF_TURPVTSATCORRECTIONS_1_1_DATA_LENGTH \
  (NAVSUPP_NBR_ACTIVESAT * (sizeof(SatCorrInfo_1_1_t) + \
                            NR_OF_ANTENNAS * NAVSUPP_NBR_ACTIVESIG * sizeof(SatClkCorrInfo_1_1_t)))
...
#ifndef SBF_NAVICRAW_1_0_NAVBITS_LENGTH 
#define SBF_NAVICRAW_1_0_NAVBITS_LENGTH 10 
#endif

#define SBF_NAVICRAW_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        Reserved;     
  uint8_t        RxChannel;    
  uint32_t       NAVBits[SBF_NAVICRAW_1_0_NAVBITS_LENGTH];
} NAVICRaw_1_0_t;

#define SBF_NAVICRAW_1_NAVBITS_LENGTH SBF_NAVICRAW_1_0_NAVBITS_LENGTH
typedef NAVICRaw_1_0_t NAVICRaw_1_t;
...
typedef struct
{
  ...
  float          IDOT;         /* Inclination Angle Rate (semi-circles/s) [MT11] */
...
#define SBF_CMPALM_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  float          OMEGADOT;     /* Rate of Right Ascen (r/s) */
  float          delta_i;      /* Orbital Inclination (semi-circles) */
  float          a_f0;         /* Clock correction a_0 (s). */
  float          a_f1;         /* Clock correction a_1 (s/s). */
...
typedef cmpAlm_1_0_t cmpAlm_1_t;

typedef BDSAlm_1_0_t BDSAlm_1_t;
...
#define SBF_QZALM_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        PRN;          
  uint8_t        Reserved;     
  float          e;            /* Difference from reference eccentricity */
  uint32_t       t_oa;         /* Reference time of almanac (s) */
  float          delta_i;      /* Orbital Inclination (semi-circles) */
  float          OMEGADOT;     /* Rate of Right Ascen (r/s) */
  float          SQRT_A;       /* SQRT(A) (m^1/2) */
...
typedef qzAlm_1_0_t qzAlm_1_t;

typedef QZSAlm_1_0_t QZSAlm_1_t;
...
#ifndef SBF_PVTGEODETICAUTH_1_0__PADDING_LENGTH 
#define SBF_PVTGEODETICAUTH_1_0__PADDING_LENGTH 3 
#endif

#define SBF_PVTGEODETICAUTH_1_0_TOW_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_0_LATITUDE_PRECISION 12
#define SBF_PVTGEODETICAUTH_1_0_LONGITUDE_PRECISION 12
#define SBF_PVTGEODETICAUTH_1_0_HEIGHT_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_0_UNDULATION_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_0_VN_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_0_VE_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_0_VU_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_0_COG_PRECISION 2
#define SBF_PVTGEODETICAUTH_1_0_RXCLKBIAS_PRECISION 6
#define SBF_PVTGEODETICAUTH_1_0_RXCLKDRIFT_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        _padding[SBF_PVTGEODETICAUTH_1_0__PADDING_LENGTH];
} PVTGeodeticAuth_1_0_t;

/*--PVTGeodeticAuth_1_1_t : -------------------------------------------------*/
/* OSNMA-Authenticated Position, velocity, and time in geodetic coordinates */

#define SBF_PVTGEODETICAUTH_1_1_TOW_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_1_LATITUDE_PRECISION 12
#define SBF_PVTGEODETICAUTH_1_1_LONGITUDE_PRECISION 12
#define SBF_PVTGEODETICAUTH_1_1_HEIGHT_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_1_UNDULATION_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_1_VN_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_1_VE_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_1_VU_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_1_COG_PRECISION 2
#define SBF_PVTGEODETICAUTH_1_1_RXCLKBIAS_PRECISION 6
#define SBF_PVTGEODETICAUTH_1_1_RXCLKDRIFT_PRECISION 3
...
#ifndef SBF_PVTGEODETICAUTH_1_2__PADDING_LENGTH 
#define SBF_PVTGEODETICAUTH_1_2__PADDING_LENGTH 1 
#endif

#define SBF_PVTGEODETICAUTH_1_2_TOW_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_LATITUDE_PRECISION 12
#define SBF_PVTGEODETICAUTH_1_2_LONGITUDE_PRECISION 12
#define SBF_PVTGEODETICAUTH_1_2_HEIGHT_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_UNDULATION_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_VN_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_VE_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_VU_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_COG_PRECISION 2
#define SBF_PVTGEODETICAUTH_1_2_RXCLKBIAS_PRECISION 6
#define SBF_PVTGEODETICAUTH_1_2_RXCLKDRIFT_PRECISION 3
#define SBF_PVTGEODETICAUTH_1_2_HACCURACY_PRECISION 2
#define SBF_PVTGEODETICAUTH_1_2_VACCURACY_PRECISION 2
...
typedef struct
{
  ...
  uint8_t        _padding[SBF_PVTGEODETICAUTH_1_2__PADDING_LENGTH];
} PVTGeodeticAuth_1_2_t;

#define SBF_PVTGEODETICAUTH_1__PADDING_LENGTH SBF_PVTGEODETICAUTH_1_2__PADDING_LENGTH
typedef PVTGeodeticAuth_1_2_t PVTGeodeticAuth_1_t;
...
#define SBF_INSNAVCARTPOSCOV_1_0_XYCOV_PRECISION 3
#define SBF_INSNAVCARTPOSCOV_1_0_XZCOV_PRECISION 3
#define SBF_INSNAVCARTPOSCOV_1_0_YZCOV_PRECISION 3
...
#define SBF_INSNAVCARTATTCOV_1_0_HEADINGPITCHCOV_PRECISION 6
#define SBF_INSNAVCARTATTCOV_1_0_HEADINGROLLCOV_PRECISION 6
#define SBF_INSNAVCARTATTCOV_1_0_PITCHROLLCOV_PRECISION 6

/** INSNavCartAttCov_1_0_t */
typedef struct
{
  float          HeadingPitchCov;
  float          HeadingRollCov;
  float          PitchRollCov; 
} INSNavCartAttCov_1_0_t;
...
#define SBF_INSNAVCARTVELCOV_1_0_VXVYCOV_PRECISION 3
#define SBF_INSNAVCARTVELCOV_1_0_VXVZCOV_PRECISION 3
#define SBF_INSNAVCARTVELCOV_1_0_VYVZCOV_PRECISION 3
...
#define SBF_INSNAVGEODPOSCOV_1_0_LATITUDELONGITUDECOV_PRECISION 3
#define SBF_INSNAVGEODPOSCOV_1_0_LATITUDEHEIGHTCOV_PRECISION 3
#define SBF_INSNAVGEODPOSCOV_1_0_LONGITUDEHEIGHTCOV_PRECISION 3

/** INSNavGeodPosCov_1_0_t */
typedef struct
{
  float          LatitudeLongitudeCov;
  float          LatitudeHeightCov;
  float          LongitudeHeightCov;
} INSNavGeodPosCov_1_0_t;
...
#define SBF_INSNAVGEODATTCOV_1_0_HEADINGPITCHCOV_PRECISION 6
#define SBF_INSNAVGEODATTCOV_1_0_HEADINGROLLCOV_PRECISION 6
#define SBF_INSNAVGEODATTCOV_1_0_PITCHROLLCOV_PRECISION 6
...
#define SBF_INSNAVGEODVELCOV_1_0_VEVNCOV_PRECISION 3
#define SBF_INSNAVGEODVELCOV_1_0_VEVUCOV_PRECISION 3
#define SBF_INSNAVGEODVELCOV_1_0_VNVUCOV_PRECISION 3
...
#define SBF_EXTEVENTATTEULER_1_0_TOW_PRECISION 3
#define SBF_EXTEVENTATTEULER_1_0_HEADING_PRECISION 6
#define SBF_EXTEVENTATTEULER_1_0_PITCH_PRECISION 6
#define SBF_EXTEVENTATTEULER_1_0_ROLL_PRECISION 6
#define SBF_EXTEVENTATTEULER_1_0_PITCHDOT_PRECISION 3
#define SBF_EXTEVENTATTEULER_1_0_ROLLDOT_PRECISION 3
#define SBF_EXTEVENTATTEULER_1_0_HEADINGDOT_PRECISION 3
...
typedef ExtEventAttEuler_1_0_t ExtEventAttEuler_1_t;
...
#define SBF_LBANDTRACKERSTATUS_1_0_TRACKDATA_LENGTH 5 
#endif
...
#define SBF_LBANDTRACKERSTATUS_1_1_TRACKDATA_LENGTH 5 
#endif
...
#define SBF_LBANDTRACKERSTATUS_1_2_TRACKDATA_LENGTH 5 
#endif
...
#define SBF_LBANDTRACKERSTATUS_1_3_TRACKDATA_LENGTH 5 
#endif
...
#ifndef SBF_MACKSTATUS_1_0__PADDING_LENGTH 
#define SBF_MACKSTATUS_1_0__PADDING_LENGTH 1 
#endif
...
typedef struct
{
  ...
  uint8_t        _padding[SBF_MACKSTATUS_1_0__PADDING_LENGTH];
} MACKStatus_1_0_t;

#ifndef SBF_OSNMASTATUS_1_0_RESERVED1_LENGTH 
#define SBF_OSNMASTATUS_1_0_RESERVED1_LENGTH 7 
#endif

#ifndef SBF_OSNMASTATUS_1_0_MACKSTATUS_LENGTH 
#define SBF_OSNMASTATUS_1_0_MACKSTATUS_LENGTH 14 
#endif

#define SBF_OSNMASTATUS_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        N;            
  uint8_t        ValidData;    
  uint16_t       Chain1_Status;
  uint16_t       Chain2_Status;
  uint16_t       Chain3_Status;
  uint16_t       Chain4_Status;
  uint16_t       PKR_Status;   
  uint8_t        NMAStatus;    
  uint8_t        ChainID;      
  uint8_t        CPKS;         
  ...
  uint16_t       KeySize;      
  uint8_t        MacSize;      
  uint8_t        MacLookupTable;
  uint8_t        SVID;         
  uint8_t        KRootTOWH;    
  uint16_t       KRootWN;      
  uint8_t        EmergencyMsgReceived;
  uint8_t        Reserved1[SBF_OSNMASTATUS_1_0_RESERVED1_LENGTH];
  MACKStatus_1_0_t MACKStatus[SBF_OSNMASTATUS_1_0_MACKSTATUS_LENGTH];
} OSNMAStatus_1_0_t;

#define SBF_MACKSTATUS_1__PADDING_LENGTH SBF_MACKSTATUS_1_0__PADDING_LENGTH
typedef MACKStatus_1_0_t MACKStatus_1_t;

#define SBF_OSNMASTATUS_1_RESERVED1_LENGTH SBF_OSNMASTATUS_1_0_RESERVED1_LENGTH
#define SBF_OSNMASTATUS_1_MACKSTATUS_LENGTH SBF_OSNMASTATUS_1_0_MACKSTATUS_LENGTH
typedef OSNMAStatus_1_0_t OSNMAStatus_1_t;
...
#ifndef SBF_INAVMONITOR_1_0__PADDING_LENGTH 
#define SBF_INAVMONITOR_1_0__PADDING_LENGTH 3 
#endif

#define SBF_INAVMONITOR_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        _padding[SBF_INAVMONITOR_1_0__PADDING_LENGTH];
} INAVmonitor_1_0_t;

#define SBF_INAVMONITOR_1__PADDING_LENGTH SBF_INAVMONITOR_1_0__PADDING_LENGTH
typedef INAVmonitor_1_0_t INAVmonitor_1_t;
...
#ifndef SBF_P2PPSTATUS_1_0_P2PPSESSION_LENGTH 
#define SBF_P2PPSTATUS_1_0_P2PPSESSION_LENGTH 4 
#endif

#define SBF_P2PPSTATUS_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        N;            
  uint8_t        SBLength;     
  P2PPSession_1_0_t P2PPSession[SBF_P2PPSTATUS_1_0_P2PPSESSION_LENGTH];
} P2PPStatus_1_0_t;

typedef P2PPSession_1_0_t P2PPSession_1_t;

#define SBF_P2PPSTATUS_1_P2PPSESSION_LENGTH SBF_P2PPSTATUS_1_0_P2PPSESSION_LENGTH
typedef P2PPStatus_1_0_t P2PPStatus_1_t;

/*--AuthenticationStatus_1_0_t : --------------------------------------------*/

#define SBF_AUTHENTICATIONSTATUS_1_0_TOW_PRECISION 3
...
typedef AuthenticationStatus_1_0_t AuthenticationStatus_1_t;
...
#ifndef SBF_RAWDATAIN_1_0_BYTES_LENGTH 
#define SBF_RAWDATAIN_1_0_BYTES_LENGTH 4096 
#endif

#define SBF_RAWDATAIN_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        Mode;         
  uint8_t        Source;       
  uint8_t        Bytes[SBF_RAWDATAIN_1_0_BYTES_LENGTH];
} RawDataIn_1_0_t;

#define SBF_RAWDATAIN_1_BYTES_LENGTH SBF_RAWDATAIN_1_0_BYTES_LENGTH
typedef RawDataIn_1_0_t RawDataIn_1_t;
...
#ifndef SBF_TURPVTSATCORRECTIONS_1_1_DATA_LENGTH 
#define SBF_TURPVTSATCORRECTIONS_1_1_DATA_LENGTH -1 
#endif

#define SBF_TURPVTSATCORRECTIONS_1_1_TOW_PRECISION 3
...
typedef struct
{
  ...
  uint8_t        SB2Length;    
  uint8_t        Reserved[3];  
  uint8_t        Data[SBF_TURPVTSATCORRECTIONS_1_1_DATA_LENGTH];
} TURPVTSatCorrections_1_1_t;

typedef SatClkCorrInfo_1_1_t SatClkCorrInfo_1_t;

typedef SatCorrInfo_1_1_t SatCorrInfo_1_t;

#define SBF_TURPVTSATCORRECTIONS_1_DATA_LENGTH SBF_TURPVTSATCORRECTIONS_1_1_DATA_LENGTH
typedef TURPVTSatCorrections_1_1_t TURPVTSatCorrections_1_t;
...
#define SBF_FOCTURNSTATUS_1_0_TOW_PRECISION 3
...
typedef struct
{
  ...
  int16_t        DIG_FpgaTemp; 
  uint16_t       DIG_VCCINT;   
  uint16_t       DIG_VCCAUX;   
  uint16_t       DIG_VCCBRAM;  
  uint16_t       DIG_VCC_12V_DIG_SW;
  uint16_t       DIG_VCC_5V_SM;
  uint16_t       DIG_VCC_FPGA_1V5;
  uint16_t       DIG_VCC_3V7;  
  uint16_t       DIG_VCC_12V_RF_SW;
  uint16_t       DIG_VCC_5V1;  
  uint16_t       DIG_VCC_2V5;  
  int16_t        RF_FpgaTemp;  
  uint16_t       RF_VCCINT;    
  uint16_t       RF_VCCAUX;    
  uint16_t       RF_VCCBRAM;   
  uint16_t       RF_VCC_12V;   
  uint16_t       RF_VCC_5V5;   
  uint16_t       RF_VCC_3V6_RF;
  uint16_t       Reserved;     
  uint32_t       TTFF;         
} FOCTURNStatus_1_0_t;

typedef FOCTURNStatus_1_0_t FOCTURNStatus_1_t;

/*--TGVFXStatus_1_0_t : -----------------------------------------------------*/

#define SBF_TGVFXSTATUS_1_0_TOW_PRECISION 3
...
typedef TGVFXStatus_1_0_t TGVFXStatus_1_t;
...
//! Typedef for the SBF Header structure
typedef BlockHeader_t HeaderBlock_t;
typedef TimeHeader_t HeaderAndTimeBlock_t;

/** \brief Typedef to get a generic SBF block header
 *
 ...
 *  first a uint8_t[] buffer should be created that is large enough
...
typedef NAVICRaw_1_0_t IRNSSRaw_1_0_t;
typedef NAVICRaw_1_t   IRNSSRaw_1_t;

#define sbfnr_IRNSSRaw_1   sbfnr_NAVICRaw_1
#define sbfid_IRNSSRaw_1_0 sbfid_NAVICRaw_1_0
...
typedef SatCorrInfo_1_1_t SatCorrInfo_t;
